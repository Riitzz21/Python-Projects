...
Build a Python script that calculates a fun "campatibility score" 
between two friends based on their names.

Your Program Should :
1. Ask for two names (friend A and friend B).
2. Count shared letters, vowels, and character positions to create 
...
def run_friendship_calculator():
    ...
    if score >= 80:
        ...
        print("You're a kind of warm spices.")
    else:
