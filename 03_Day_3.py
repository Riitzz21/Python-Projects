...
Example :
Total bill: 1200 rupees
People: Aman, Neha, Ravi, Ritzz

Each person owes : 400 rupees

Final Output : 

Aman owes : 400 rupees
Neha owes : 400 rupees
Ravi owes : 400 rupees
Ritzz owes : 400 rupees
...
for i in range(num_people):
    name = input(f"Enter the name of person one #{i+1}").strip()
    names.append(name)
