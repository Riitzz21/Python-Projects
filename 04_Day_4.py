...
Assumptions :
- You can use 365.25 days/years to account for leap year.
- You don't need to handle time zones or exact birth dates in this version.
...
def calulate_minutes(age_years):
    DAYS_IN_YEAR = 365.25
    HOURS_IN_DAY = 24
    MINUTES_IN_DAY = 60
    ...
    total_minutes = total_hours * MINUTES_IN_DAY
...
while True:
    try:
        ...
        days, hours, minutes = calulate_minutes(age)
