...
Build a python script that allows you to maintain a daily learning journal. 
Each entry will be saved into a '.txt' file along with a timestamp.
...
print(f"\n Your journal entry has been saved to 'learning _journal.txt' file.")